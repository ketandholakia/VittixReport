...
""")
        ...
        if "function TReportScriptHostAdapter.ExecuteSingleBeforeObject" in line:
            ...
            for key, block in handlers:
                out_lines.append(f"  FHandlers.Add('{key}', Cmd_{key.capitalize()});\n")
            out_lines.append("end;\n\n")
    ...
    # We must do a second pass to insert the method declarations since handlers are collected later
    # Actually, we can just replace a placeholder!
    placeholder_idx = -1
