...

{
  ...
  It owns:
    ...
    * A Variables TStringList -- design-time named constants stored in the .vrt
      file, resolved as [VarName] tokens in expressions.
...
type
  ...
  private
    ...
    FVariables:    TStringList;              // design-time named constants
    FTitle:        string;
    FAuthor:       string;
    FDescription:  string;
  public
    ...
    ///   PageSettings, FieldNames, Variables and metadata (Title/Author/Description)
    ...
    /// <summary>
    ///   Design-time named constants stored in the .vrt file.
    ///   Values are referenced in text expressions as [VarName].
    ///   Example: Variables.Values['CompanyName'] := 'Acme Ltd';
    ///   Usage in a text object expression: [CompanyName]
    /// </summary>
...
begin
  FObjects.Clear;
  // PageSettings, FieldNames, Variables and metadata are intentionally kept
end;
