...
var
  Runs: TArray<Vittix.Report.MemoExport.TMemoRun>;
  Run: Vittix.Report.MemoExport.TMemoRun;
  Line: TMemoLine;
  I, J: Integer;
  Token: string;
  IsSpace: Boolean;
...
begin
  ...
  Vittix.Report.MemoExport.ParseMemoRuns(Text, BaseFont.Style, BaseColor, BaseFont.Name, BaseFont.Size, AllowHTML, Runs);
