...
uses
 ...
 Vcl.Forms,
  ...
  Frm.About in 'Frm.About.pas' {frmAbout},
  Vittix.Designer.IconLoader in 'Vittix.Designer.IconLoader.pas',
...
{ Application icon (MAINICON) and the brand logo used by the About dialog.
  Generated by branding\build_brand_assets.py from the artwork in \branding. }
{$R resources\vittix_app_icon.res}
